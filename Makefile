...
check:
	...
	@! grep -IUrn --color "[[:blank:]]$$" --exclude-dir=src --exclude-dir=sphinx --exclude-dir=.tox --exclude-dir=.git --exclude=PKG-INFO
	@echo "Checking for DOS line-endings"
	@! grep -lIUrn --color "" --exclude-dir=src --exclude-dir=sphinx --exclude-dir=.tox --exclude-dir=.git --exclude=Makefile
